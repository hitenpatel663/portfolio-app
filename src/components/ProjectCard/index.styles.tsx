...
export const ImageContainer = styled('img')<{ clickable?: boolean }>(({ theme, clickable }) => ({
  width: '100%',
...
export const OverLay = styled(Box)(({ theme }) => ({
  ...
  top: 0,
  cursor: 'pointer',
  background: 'linear-gradient(0deg, rgba(0,0,0,0.9) 0%, rgba(255,255,255,0.2) 100%) transparent',
}));
